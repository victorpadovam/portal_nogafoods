                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body" id="schedule">
                            @include('vendor-views.product.partials._schedule', $product)
                        </div>
                    </div>
                </div>
                <!-- End Item Schedule -->
...
<div class="col-xl-4 col-lg-6">
    ...
    function add_more_customer_choice_option(i, name) {
        ...
        $('#exampleModal').on('show.bs.modal', function (event) {
            ...
            let item_id = button.data('productid');
            let modal = $(this);
            ...
            modal.find('.modal-body input[name=product_id]').val(item_id);
        });
        ...
        $('#add-schedule').on('submit', function (e) {
            ...
            $.post({
                url: '{{route('vendor.item.add-schedule')}}',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
