...
<div class="schedule-item">
    ...
    <div class="schedult-date-content">
        ...
        <div class="d-inline-flex align-items-center">
            ...
            <span class="dismiss--date delete-schedule" data-url="{{ route('vendor.item.remove-schedule', ['item_schedule' => $day['id']]) }}">
        ...
        @endif
        <span class="btn add--primary" data-toggle="modal" data-target="#exampleModal" data-dayid="{{ $dayId }}" data-day="{{ translate('messages.' . $dayName) }}" data-productid="{{ $product->id }}">
            <i class="tio-add"></i>
        </span>
    </div>
</div>
