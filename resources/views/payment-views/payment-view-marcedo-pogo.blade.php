...
// $raw = '{
//     "back_urll": {
//         "success": "https://portal.nogafoods.com.br/payment-success?payment_id='.$data->id.'",
//         "failure": "https://portal.nogafoods.com.br/payment-failed?payment_id='.$data->id.'",
//         "pending": "https://portal.nogafoods.com.br/payment-pending?payment_id='.$data->id.'"
//     },
//     "auto_return": "approved",
//     "notification_url": "https://portal.nogafoods.com.br/payment-success?payment_id='.$data->id.'",
//     "payment_methods": {
...
//     "items": [
//         {
//             "title": "'.$data->additional_data->business_name.'",
//             "quantity": 1,
//             "currency_id": "BRL",
//             "unit_price": '.$data->payment_amount.',
//             "picture_url": ""
//         }
//     ]
...
//     }';
// $ch = curl_init();
// curl_setopt($ch, CURLOPT_URL, "https://api.mercadopago.com/checkout/preferences?access_token=APP_USR-a41589de-0dc2-494a-82a1-7676d5c1c856" );
...
// header("Location: $result->sandboxinit_point");
// exit;
