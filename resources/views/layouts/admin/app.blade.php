...
<head>
    ...
    <link rel="icon" type="image/x-icon"
        href="{{ \App\CentralLogics\Helpers::get_image_helper($logo, 'value', asset('storage/app/public/business/') . '/' . $logo?->value, asset('/assets/admin/img/160x160/img1.jpg'), 'business/') }}">
    <!-- Font -->
                            ...
                            <div class="col-12">
                                <div class="text-center">
                                    ...
                                    <button class="btn btn-primary check-order"
                                        onclick="pauseAudio()">{{ translate('messages.Ok, let me check') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
