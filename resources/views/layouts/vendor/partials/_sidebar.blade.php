...
<style>
    ...
    .navbar-vertical-aside-has-menu:hover,
    .navbar-vertical-aside-has-menu.active:hover {
        background-color: #FF4500;
    }

    .navbar-vertical-aside-has-menu.active .nav-icon {
        color: white !important;
        font-size: 1.5em;
    }

    .navbar-vertical-aside-has-menu.active::before,
    .navbar-vertical-aside-has-menu.active::after {
        content: none !important;
    }

    .navbar-vertical-aside-has-menu.active,
    .navbar-vertical-aside-has-menu.active .nav-icon,
    .navbar-vertical-aside-has-menu.active .arrow-icon,
    .navbar-vertical-aside-has-menu.active .navbar-vertical-aside-mini-mode-hidden-elements {
        color: white !important;
    }

    /* Efeito hover para o texto e ícones */
    .navbar-vertical-aside-has-menu:hover .nav-icon,
    .navbar-vertical-aside-has-menu:hover .arrow-icon,
    .navbar-vertical-aside-has-menu:hover .navbar-vertical-aside-mini-mode-hidden-elements {
        color: white !important;
    }
    </style>
        ...
        <div class="navbar-vertical-container">
            <div class="navbar-brand-wrapper justify-content-between">
                ...
                <a class="navbar-brand" href="{{route('vendor.dashboard')}}" aria-label="Front">
                    <img class="navbar-brand-logo initial--36  onerror-image" data-onerror-image="{{asset('public/assets/admin/img/160x160/img2.jpg')}}" src="{{\App\CentralLogics\Helpers::get_image_helper($store_data,'logo', asset('storage/app/public/store/').'/'.$store_data->logo, asset('public/assets/admin/img/160x160/img2.jpg'), 'store/') }}" alt="Logo">
                    <img class="navbar-brand-logo-mini initial--36 onerror-image" data-onerror-image="{{asset('public/assets/admin/img/160x160/img2.jpg')}}" src="{{\App\CentralLogics\Helpers::get_image_helper($store_data,'logo', asset('storage/app/public/store/').'/'.$store_data->logo, asset('public/assets/admin/img/160x160/img2.jpg'), 'store/') }}" alt="Logo">
                </a>
                <!-- End Logo -->
            ...
            <div class="navbar-vertical-content text-capitalize bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('vendor.dashboard')}}" title="{{translate('messages.dashboard')}}">
                            <i class="tio-home-vs-1-outlined nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{translate('messages.dashboard')}}
                            </span>
                            <i class="fa fa-chevron-right arrow-icon"></i> <!-- Ícone de seta -->
                        </a>
                    </li>
                    <!-- End Dashboards -->
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/pos')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link  " href="{{route('vendor.pos.index')}}" title="{{translate('messages.pos')}}">
                            <i class="tio-shopping-basket-outlined nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{translate('messages.pos')}}
                            </span>
                            <i class="fa fa-chevron-right arrow-icon"></i> <!-- Ícone de seta -->
                        </a>
                    </li>
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/category*')?'active':''}}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: {{Request::is('store-panel/category*')?'block':'none'}}">
                            <li class="nav-item {{Request::is('store-panel/category/list')?'active':''}}">
                                <a class="nav-link " href="{{route('vendor.category.add')}}" title="{{translate('messages.category')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                            ...
                            <li class="nav-item {{Request::is('store-panel/category/sub-category-list')?'active':''}}">
                                <a class="nav-link " href="{{route('vendor.category.add-sub-category')}}" title="{{translate('messages.sub_category')}}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                    ...
                    <li class="nav-item">
                        <small class="nav-subtitle" title="{{translate('messages.deliveryman_section')}}">{{translate('messages.deliveryman_section')}}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/delivery-man/add')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('vendor.delivery-man.add')}}" title="{{translate('messages.add_delivery_man')}}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/delivery-man/list')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('vendor.delivery-man.list')}}" title="{{translate('messages.deliveryman')}}">
                    ...
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('vendor.delivery-man.reviews.list')}}" title="{{translate('messages.reviews')}}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/coupon*') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('vendor.coupon.add-new') }}" title="{{ translate('messages.coupons') }}">
                    ...
                    <!-- Business Section-->
                    <li class="nav-item">
                        <small class="nav-subtitle" title="{{translate('messages.business_section')}}">{{translate('messages.business_section')}}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>

                    @if(\App\CentralLogics\Helpers::employee_module_permission_check('store_setup'))
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/business-settings/store-setup')?'active':''}}">
                        <a class="nav-link " href="{{route('vendor.business-settings.store-setup')}}" title="{{translate('messages.storeConfig')}}">
                            <i class="tio-settings nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{translate('messages.storeConfig')}}
                            </span>
                            <i class="fa fa-chevron-right arrow-icon"></i> <!-- Ícone de seta -->
                        </a>
                    </li>
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/store/*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('vendor.shop.view')}}" title="{{translate('messages.my_shop')}}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/wallet')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('vendor.wallet.index')}}" title="{{translate('messages.my_wallet')}}">
                            <i class="fa fa-wallet nav-icon"></i> <!-- Ícone de carteira -->
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('metodo-de-pagamento-lojista')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('metodo-de-pagamento-lojista')}}" title="{{translate('messages.metodo_de_pagamentos_lojista')}}">
                            <i class="tio-wallet nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('messages.metodo_de_pagamentos_lojista')}}</span>
                            <i class="fa fa-chevron-right arrow-icon"></i> <!-- Ícone de seta -->
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/reviews')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('vendor.reviews')}}" title="{{translate('messages.reviews')}}">
                            <i class="tio-star-outlined nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{translate('messages.reviews')}}
                            </span>
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/message*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('vendor.message.list')}}" title="{{translate('messages.chat')}}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/report/expense-report') ? 'active' : '' }}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/report/disbursement-report') ? 'active' : '' }}">
                        <a class="nav-link " href="{{ route('vendor.report.disbursement-report') }}" title="{{ translate('messages.disbursement_report') }}">
                            <i class="tio-saving nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{ translate('messages.disbursement_report') }}
                            </span>
                            <i class="fa fa-chevron-right arrow-icon"></i>
                        </a>
                    </li>
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/custom-role*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('vendor.custom-role.create')}}" title="{{translate('messages.employee_Role')}}">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/employee*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:" title="{{translate('messages.employees')}}">
                    ...
                    <li class="nav-item py-5">
                        <a class="nav-link " href="https://nogafoodsparceiros.tawk.help/"  target="_blank">
                            <center>
                                <img src="{{asset('public/assets/admin/img/central_de_ajuda.png')}}" width="100%">
                            </center>
                        </a>
                        <a class="nav-link " href="https://parceiros.nogafoodsdelivery.com.br/links/"  target="_blank">
                            <center>
                                <img src="{{asset('public/assets/admin/img/mais_solucoes.png')}}" width="100%">
                            </center>
                        </a>
                        <a class="nav-link ">
                            <center>
                                <img src="{{asset('public/assets/admin/img/noga_foods_logo.png')}}" width="100%">
                            </center>
                        </a>
                    </li>
