                    ...
                    <li class="nav-item max-sm-m-0">
                        <div class="hs-unfold">
                            <div class="d-flex align-items-center">
                                <h1 class="page-header-title mb-0 mr-2 d-none d-lg-block">Estabelecimento</h1>
                                @php($isStoreOpen=\App\CentralLogics\Helpers::get_store_data()->active)
                                @if($isStoreOpen==1)
                                <img src="{{ asset('public/assets/admin/img/botao_loja_aberto.png') }}" alt="Botão de loja aberto" class="img-fluid restaurant-open-status" width="225">
                                @else
                                <img src="{{ asset('public/assets/admin/img/botao_loja_fechado.png') }}" alt="Botão de loja fechado" class="img-fluid restaurant-open-status" width="225">
                                @endif
                            </div>
                        </div>
                    </li>
                    <li class="nav-item d-none d-lg-inline-block mr-4">
                        <!-- Notification -->
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon btn-soft-secondary rounded-circle" href="{{route('vendor.message.list')}}">
                            ...
                            <a class="js-hs-unfold-invoker navbar-dropdown-account-wrapper" href="javascript:;" data-hs-unfold-options='{
                                ...
                                <div class="cmn--media right-dropdown-icon d-flex align-items-center">
                                    ...
                                    <div class="avatar avatar-sm avatar-circle">
                                        <img class="avatar-img  onerror-image" data-onerror-image="{{asset('public/assets/admin/img/160x160/img1.jpg')}}" src="{{\App\CentralLogics\Helpers::get_image_helper(\App\CentralLogics\Helpers::get_loggedin_user(),'image', asset('storage/app/public/vendor/').'/'.\App\CentralLogics\Helpers::get_loggedin_user()->image, asset('public/assets/admin/img/160x160/img1.jpg'), 'vendor/') }}" alt="Image Description">
                                        <span class="avatar-status avatar-sm-status avatar-status-success"></span>
                                    </div>
                                </div>
                            </a>

                            <div id="accountNavbarDropdown" class="hs-unfold-content dropdown-unfold dropdown-menu dropdown-menu-right navbar-dropdown-menu navbar-dropdown-account min--240">
                                <div class="dropdown-item-text">
                                    <div class="media align-items-center">
                                        <div class="avatar avatar-sm avatar-circle mr-2">
                                            <img class="avatar-img  onerror-image" data-onerror-image="{{asset('public/assets/admin/img/160x160/img1.jpg')}}" src="{{\App\CentralLogics\Helpers::get_image_helper(\App\CentralLogics\Helpers::get_loggedin_user(),'image', asset('storage/app/public/vendor/').'/'.\App\CentralLogics\Helpers::get_loggedin_user()->image, asset('public/assets/admin/img/160x160/img1.jpg'), 'vendor/') }}" alt="Owner image">
                                        </div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                $(document).on('click', '.restaurant-open-status', function(event) {
                    Swal.fire({
                        ...
                        text: "{{$store_data->active ? translate('messages.you_want_to_temporarily_close_this_store') : translate('messages.you_want_to_open_this_store') }}",
                        type: 'warning',
                        showCancelButton: true,
