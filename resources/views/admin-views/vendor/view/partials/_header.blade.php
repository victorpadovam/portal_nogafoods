    ...
    <div class="page-header pb-0">
        <div class="d-flex justify-content-between">
            ...
            <div>
                ...
                <button type="submit" class="btn btn--primary text-capitalize font-weight-bold float-right mr-2"><i
                        class="tio-save font-weight-bold pr-1"></i>Salvar Alterações</button>

                <a class="btn btn--primary text-capitalize font-weight-bold float-right mr-2" data-toggle="modal"
                    data-target="#contratoModal">
                    <i class="tio-document-text font-weight-bold pr-1"></i>Contrato
                </a>
            </div>
        </div>
        @if ($store->vendor->status)
