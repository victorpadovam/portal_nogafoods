            ...
            <div class="col-lg-6">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="neighborhood" class="form-control" value="{{ $store->neighborhood }}" >
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">CEP</label>
                        <input type="text" name="cep" class="form-control" value="{{ $store->cep }}" >
                    </div>
            ...
            <div class="col-md-6">
                ...
                <select name="module_id" class="form-control">
                    @foreach ($modules as $module)
                        <option
                            value="{{ $module->id }}"
                            @selected($module->id == $store->module_id)
                        >
                            {{ $module->module_name }}
                        </option>
                    @endforeach
