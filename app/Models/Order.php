...
class Order extends Model
{
    ...
    protected $fillable = [
    'payment_status', 'payment_method', 'user_id', 'order_amount', 
    'coupon_discount_amount', 'coupon_discount_title', 'order_status', 
    'total_tax_amount', 'transaction_reference', 'delivery_address_id', 
    'delivery_man_id', 'coupon_code', 'order_note', 'order_type', 
    'checked', 'store_id', 'delivery_charge', 'schedule_at', 'callback', 
    'otp', 'pending', 'accepted', 'confirmed', 'processing', 'handover', 
    'picked_up', 'delivered', 'canceled', 'refund_requested', 
    'refunded', 'delivery_address'
];
