...
Route::get('deeplink/productId/{productId}/storeId/{storeId}', 'DeepLinkController@handleDeepLink');


//MetodoDePagamentoPageLojista
Route::get('verificaSeLojistaTemPixECartaoAtivados/{store_id}', 'MetodoDePagamentosConfigLojistaController@verificaSeLojistaTemPixECartaoAtivados'); //api

Route::get('metodo-de-pagamento-lojista', 'MetodoDePagamentosConfigLojistaController@index')->name('metodo-de-pagamento-lojista');
