...
Route::get('mercadopago-autoriza-contas', 'PagamentoMercadoPagoController@geraTokenAutorizacaoEntreContasVinculadas');

Route::post('gerarPIXQrCodeComSplitDePagamento', 'PagamentoMercadoPagoController@gerarPIXQrCodeComSplitDePagamento');

Route::post('gerarPIXQrCodeDiretoContaNogaF', 'PagamentoMercadoPagoController@gerarPIXQrCodeDiretoContaNogaF');

Route::post('alterarStatusPagamentoAprovado', 'PagamentoMercadoPagoController@alterarStatusPagamentoAprovado');

Route::post('getPaymentByPreferenceId', 'PagamentoMercadoPagoController@getPaymentByPreferenceId');


Route::post('createPreference', 'PagamentoMercadoPagoController@createPreference');

Route::post('gerarPagamentoCartaoESplitDePagamento', 'PagamentoMercadoPagoController@gerarPagamentoCartaoESplitDePagamento');

Route::get('listagemDeBandeirasDisponiveisMP', 'PagamentoMercadoPagoController@listagemDeBandeirasDisponiveisMP');

Route::get('buscarPagamentoPix', 'PagamentoMercadoPagoController@buscarPagamentoPix');
...
Route::group(['namespace' => 'Api\V1', 'middleware' => 'localization'], function () {
    ...
    Route::group(['prefix' => 'vendor', 'namespace' => 'Vendor', 'middleware' => ['vendor.api']], function () {
        ...
        Route::group(['prefix' => 'item'], function () {
            ...
            Route::get('schedule/{product_id}', 'ItemController@get_schedule');
            Route::post('schedule', 'ItemController@add_schedule');
            Route::delete('schedule/{schedule_id}', 'ItemController@remove_schedule');
        });
    ...
    Route::group(['middleware' => ['module-check']], function () {
        ...
        Route::group(['prefix' => 'items'], function () {
            ...
            // Route::get('details/deplink/{id}', 'ItemController@get_product_deplink');
